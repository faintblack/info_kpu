                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center" width="200px">
                                            <?php 
                                            echo anchor(site_url('dapil/read/'.$dapil->id_dapil),' ', 'class="glyphicon glyphicon-eye-open"'); 
                                            echo ' '; 
                                            echo anchor(site_url('dapil/update/'.$dapil->id_dapil),' ', 'class="glyphicon glyphicon-pencil"'); 
                                            echo ' '; 
                                            echo anchor(site_url('dapil/delete/'.$dapil->id_dapil),' ','class="glyphicon glyphicon-trash" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                            ?>
                                        </td>
                                    </tr>
                                <?php
